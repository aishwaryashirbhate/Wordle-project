...
import HW4_Aishwarya_Shirbhate_dictionary as Module_dictionary
import HW4_Aishwarya_Shirbhate_wordle as Module_wordle
...
def game_stats(history):
   ...
   :param history:
    ...
    print("total no of games won are:", won_games)          # displays no of won games
    print("total no of games lost are:", lost_games)        # displays no of lost games
