...
import HW06_Aishwarya_Shirbhate_dictionary_final as dict
import HW06_Aishwarya_Shirbhate_wordle_final as w
import HW06_Aishwarya_Shirbhate_ui_final as ui
import HW06_Aishwarya_Shirbhate_utility_final as uty
...
class wordle_test(unittest.TestCase):
    ...
    def test_case15(self):  # checks if all 5-letter words are returned to the function
        self.assertEqual(len(uty.five_letter_word()), 1379)
