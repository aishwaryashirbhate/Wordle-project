...
class word_guess:
    ...
    def get_variable(self):
        return self.theAns,self.theGuess

    def set_variables(self,answer,guess):
        self.theAns=answer
        self.theGuess=guess

    def wordGuesser(self):
        """
        ...
        """
        try:
            ansList = list(self.get_variable()[0])
            guessList = list(self.get_variable()[1])
            arr_guess = ['"', '"', '"', '"', '"']
